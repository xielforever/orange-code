...
def draw_syntactic_core_logo(filename, transparent=True):
    # Canvas parameters
...
if __name__ == "__main__":
    ...
    draw_syntactic_core_logo("/workspace/assets/logos/orange_code_logo_transparent.png", transparent=True)
